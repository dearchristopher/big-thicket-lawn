import { Home, Users, Zap, Shield, Star, Heart, Award, Check } from 'lucide-react'
import { useActiveWhyChooseUs, useSiteSettings } from '../../hooks/useSanity'
...
export const WhyChooseUsDynamic = () => {
  const { data: reasons, loading } = useActiveWhyChooseUs()
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-green-50 to-gray-50 border-t-4 border-green-600">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="h-6 bg-green-200 rounded-full w-48 mx-auto mb-4 animate-pulse"></div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {displayReasons.map((reason) => {
            const IconComponent = reason.iconName ? iconMap[reason.iconName] : Home
